<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <br>
      <el-button type="primary" style="width:100%;margin-bottom:30px;" @click="showDialog=true">从第三方登入</el-button>
    </el-form>

    <el-dialog title="从第三方登入" :visible.sync="showDialog">
      本地程序无法模拟第三方登入，请和自己的第三方接口集成使用！
      <br>
      <br>
      <br>
      <social-sign />
